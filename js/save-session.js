...
(function () {
  ...
  /** @typedef {{ schemaVersion?: number, playerName?: string, beatIndex?: number, showingEnding?: boolean, unlockIds?: number[], pity?: PitySnap }} SavePayload */
  ...
  /** @type {null | (() => { playerName: string, beatIndex: number, showingEnding: boolean, startedStory: boolean })} */
